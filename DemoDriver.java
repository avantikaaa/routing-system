...
public class DemoDriver implements AppControl {
	...
	public static void main(String[] args) {
		...
		// the group
		demoFactories.add(new demo19013.FactoryDemo());
//		demoFactories.add(new demo19089.FactoryDemo());
//		demoFactories.add(new demo19070.FactoryDemo());
//		demoFactories.add(new demo19054.FactoryDemo());
		demoFactories.add(new demo19013.FactoryDemo());
		demoFactories.add(new demo19013.FactoryDemo());
